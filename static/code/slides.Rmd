...
output:
  xaringan::moon_reader:
    css: ["xaringan-themer_modify.css", "fontsrladies.css"]
    lib_dir: libs
    nature:
...
The paper is about partisanship and risk perceptions about COVID-19, and uses both experimental and observational data. I will focus on the descriptive analysis and the simple regression models we use to show partisan difference of risk perceptions in Brazil.

The paper and replication files can be found [here](https://github.com/TiagoVentura/Calvo_Ventura_LAPS_2021) on my github account. 

--
### Our Goal

A model of partisanship on three different outcomes. 
